...
@property (weak, nonatomic) IBOutlet UIImageView *movementArrowsImageView;
@property (weak, nonatomic) IBOutlet UIImageView *signupRightArrowImageView;
@property (weak, nonatomic) IBOutlet UILabel *dragMeLabel;
